...
# ------------------------ EXP --------------------------
# nb_iters=2
# exp_name=0011_transformer_fr_iter

nb_iters=2
exp_name=0011_transformer_fr_iter2

# nb_iters=3
# exp_name=0011_transformer_fr_iter3
# exp_name=asup
...
fairseq-train \
    ...
    --criterion label_smoothed_cross_entropy_fr --nb-iters $nb_iters --label-smoothing 0.1 \
    --max-tokens 3584 \
    --fp16 --update-freq 8 \
    --save-dir $save_dir \
